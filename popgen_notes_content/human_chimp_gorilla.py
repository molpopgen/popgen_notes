...
@click.command("human_chimp_gorilla")
def human_chimp_gorilla():
    tables = _make_tables()
...
@click.command("human_chimp_gorilla_colored_edges")
def human_chimp_gorilla_colored_edges():
    tables = _make_tables()
    treeseq = tables.tree_sequence()
    style = [
...
@click.command("human_chimp_gorilla_with_mutations")
def human_chimp_gorilla_with_mutations():
    tables = tskit.TableCollection(1000.0)
    human = tables.nodes.add_row(tskit.NODE_IS_SAMPLE, 0.0)
    chimp = tables.nodes.add_row(tskit.NODE_IS_SAMPLE, 0.0)
    gorilla = tables.nodes.add_row(tskit.NODE_IS_SAMPLE, 0.0)
    ...
    _ = tables.mutations.add_row(s0, node=human, time=4, derived_state="G")
    _ = tables.mutations.add_row(s1, node=hc_ca, time=7.2, derived_state="C")
    _ = tables.mutations.add_row(s2, node=gorilla, time=11, derived_state="A")
    tables.sort()
    treeseq = tables.tree_sequence()
...
@click.command("human_chimp_gorilla_with_multiple_hits")
def human_chimp_gorilla_with_multiple_hits():
    tables = tskit.TableCollection(1000.0)
    human = tables.nodes.add_row(tskit.NODE_IS_SAMPLE, 0.0)
    chimp = tables.nodes.add_row(tskit.NODE_IS_SAMPLE, 0.0)
    gorilla = tables.nodes.add_row(tskit.NODE_IS_SAMPLE, 0.0)
